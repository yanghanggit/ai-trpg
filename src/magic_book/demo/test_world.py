...
test_world: Final[World] = World(
    ...
    stages=[
        ...
        Stage(
            ...
            environment="铁栅栏门高约3米，生锈的黑色铁条编织成尖顶造型，门扇半开约45度角，门上焊接着铜制的治愈教会徽记，徽记表面氧化呈绿色。墓地占地约200平方米，地面铺设不规则的鹅卵石，石缝间长出稀疏的枯草。石质墓碑约有40余座，高度从80厘米到2米不等，参差林立排列成三排，部分墓碑向左或向右倾斜15-30度，有5座墓碑已断裂倒地。约三分之一的墓碑被深绿色藤蔓缠绕，藤蔓从地面爬升覆盖墓碑表面。鹅卵石小径宽约1米，蜿蜒穿行于墓碑之间，路面上散落着已枯萎变黑的花束残骸和灰白色的墓志铭碎片。墓地中央位置矗立着一座高约3米的石制天使雕像，雕像呈站立姿态，双手在胸前合十，面部朝下，石材表面因风化出现细密裂纹和斑驳的苔藓。墓地北侧边缘堆放着7-8具木制棺木，木材腐朽发黑，以及数把铁锹、十字镐等挖掘工具，工具表面锈蚀。浓密的暗红色雾气高度约1-1.5米，在墓碑间缓慢流动。夜空中悬挂着血红色的圆月，月光穿透雾气在地面投射出模糊摇曳的墓碑阴影。墓地西侧有15级石制台阶，宽约2米，向上延伸通往教堂主建筑的侧门。东侧有一扇黑色铁门，高约2米，宽1.5米，门框嵌入石墙，门上有生锈的铁制门栓。",
            actors=[
                Actor(
                    name="加斯科因",
